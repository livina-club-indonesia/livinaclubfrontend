  ...
  <div>
    ...
    >
      <div class="container text-center text-md-left" data-aos="fade-up">
        <h1>Welcome to L-CI</h1>
        <h2>
          Livina Club Indonesia
        </h2>
            ...
            <div class="col-lg-7 ml-auto" data-aos="fade-left">
              <div class="tab-content">
                <div id="tab-1" class="tab-pane active show">
                  <figure>
                    <img
                      :src="require('@/assets/img/features-1.png')"
                      alt=""
                      class="img-fluid"
                    />
                  </figure>
                ...
                <div id="tab-2" class="tab-pane">
                  <figure>
                    <img
                      :src="require('@/assets/img/features-2.png')"
                      alt=""
                      class="img-fluid"
                    />
                  </figure>
                ...
                <div id="tab-3" class="tab-pane">
                  <figure>
                    <img
                      :src="require('@/assets/img/features-3.png')"
                      alt=""
                      class="img-fluid"
                    />
                  </figure>
                ...
                <div id="tab-4" class="tab-pane">
                  <figure>
                    <img
                      :src="require('@/assets/img/features-4.png')"
                      alt=""
                      class="img-fluid"
                    />
                  </figure>
